    ...
    <div>
      ...
      <div className={styles.container}>
        ...
        <main className={styles.main}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', width: 800, marginTop: 40 }}>
              <div style={{ marginRight: '20%', marginBottom: '10%', display: 'flex', marginTop: 40 }}>
                ...
                <div style={{ marginLeft: -40, marginTop: 30, textAlign: 'left', fontWeight: 300 }}>
                  <h3 style={{ color: 'white' }}>BOOK ANYTIME</h3>
              ...
              <div style={{ display: 'flex', marginLeft: 200, marginTop: -100 }}>
                ...
                <div style={{ marginLeft: 7.5, marginTop: 20, textAlign: 'left', fontWeight: 300 }}>
                  <h3 style={{ color: 'white' }}>WE COME TO YOU</h3>
              ...
              <div style={{ marginLeft: '8%', marginTop: '7%', display: 'flex' }}>
                ...
                <div style={{ marginLeft: 20, textAlign: 'left', fontWeight: 300 }}>
                  <h3 style={{ color: 'white' }}>ENJOY YOUR CAR</h3>
          ...
          <section id="why-bubbly" className={styles.whybubbly}>
            <div className={styles.textWrapper}>
          ...
          <Divider />
          <div className={styles.ourupgrades}>
            <div className={styles.textWrapper}>
              <h2 className={styles.title}>Upgrades</h2>
              <p className={styles.description}>Apart from our main services, we also offer upgrades and can be added to any service! Click on view Full Menu to see all available upgrades and services.</p>
            </div>
            <UpgradesList />
          </div>
        </main>
